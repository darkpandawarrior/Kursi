...
// ponytail: identical to jvmMain/iosMain (~20 lines) — all three are Skia/RuntimeEffect backed
 ...
 * the graceful web fallback the spec calls for if RuntimeEffect misbehaves in a given browser.
 */
