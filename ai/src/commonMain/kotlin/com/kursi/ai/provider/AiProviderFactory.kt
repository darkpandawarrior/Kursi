...
fun buildProviderChain(config: AiProviderConfig): List<AiProvider> = buildList {
...
suspend fun firstAvailable(chain: List<AiProvider>): AiProvider =
    chain.firstOrNull { it.isAvailable() } ?: IsmctsOnlyProvider()
