...
object DarbarChatGenerator {
    ...
    private fun buildChatSystemPrompt(persona: BotPersona, arc: DarbarArc?): String {
    ...
    private fun buildChatUserPrompt(trigger: ChatTrigger, view: PlayerView): String {
        val context = "Coins: ${view.myCoins}, Influence left: ${view.myInfluence.size}. " +
    ...
    private fun fallbackLine(persona: BotPersona, trigger: ChatTrigger): String {
