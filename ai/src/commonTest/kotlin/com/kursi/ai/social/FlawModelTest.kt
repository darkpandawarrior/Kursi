...
class FlawModelTest {
     ...
     */
    private val vindictiveEnforcer =
        PersonalityProfile(
            bluffRate = 0.20f,
     ...
     */
    private val highBluffLeaderSchemer =
        PersonalityProfile(
            bluffRate = 0.80f,
     ...
     */
    private val cautiousChallengerProfile =
        PersonalityProfile(
            bluffRate = 0.15f,
    ...
    fun dominantFlaw_highVindictiveness_returnsVengeance() {
        assertEquals(
            CharacterFlaw.VENGEANCE,
            FlawModel.dominantFlaw(vindictiveEnforcer),
    ...
    fun dominantFlaw_highBluffLeader_returnsEgo() {
        assertEquals(
            CharacterFlaw.EGO,
            FlawModel.dominantFlaw(highBluffLeaderSchemer),
    ...
    fun dominantFlaw_impulsiveWildcard_returnsImpulse() {
        assertEquals(
            CharacterFlaw.IMPULSE,
            FlawModel.dominantFlaw(impulsiveWildcard),
    ...
    fun dominantFlaw_highChallenger_returnsParanoia() {
        assertEquals(
            ...
            FlawModel.dominantFlaw(cautiousChallengerProfile),
    ...
    fun flawsOf_highVindictiveness_includesVengeance() {
        assertTrue(
            CharacterFlaw.VENGEANCE in FlawModel.flawsOf(vindictiveEnforcer),
    ...
    fun flawsOf_highBluffLeader_includesEgo() {
        assertTrue(
            CharacterFlaw.EGO in FlawModel.flawsOf(highBluffLeaderSchemer),
    ...
    fun susceptibility_vindictiveness_scalesLinearly() {
        ...
        assertTrue(
            FlawModel.susceptibility(high, CharacterFlaw.VENGEANCE) >
    ...
    fun susceptibility_impulse_inverseOfPredictability() {
        ...
        assertTrue(
            FlawModel.susceptibility(lowPredictability, CharacterFlaw.IMPULSE) >
    ...
    fun susceptibility_presentThreshold_matchesDeclaredConstant() {
        ...
        for (flaw in CharacterFlaw.entries) {
            ...
            if (s >= FlawModel.PRESENT_THRESHOLD) {
                assertTrue(
                    flaw in FlawModel.flawsOf(profile),
